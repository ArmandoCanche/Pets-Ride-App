import {
  ...
  MenuOpen_default,
  Menu_default
} from "./chunk-GA3CTQRK.js";
import {
  Account
} from "./chunk-DMABK7ZR.js";
import "./chunk-SG4EEVEW.js";
import {
  require_browser
} from "./chunk-IFA5N44U.js";
import "./chunk-HH3U5XO4.js";
import {
  Link,
  warnOnce
} from "./chunk-XN4OY5P2.js";
import {
  BrandingContext,
...
} from "./chunk-2CIYCPEI.js";
import "./chunk-BFL632LT.js";
import "./chunk-GR2ZUMSO.js";
import "./chunk-MIT3GPW2.js";
import {
  Box_default
} from "./chunk-DCVPL4XM.js";
import "./chunk-6VFKKIW7.js";
import {
  Typography_default
} from "./chunk-EP3CH4EC.js";
import {
  Paper_default
} from "./chunk-C54JHRHV.js";
import "./chunk-A7ECLLTJ.js";
import "./chunk-C6WWHQR7.js";
import "./chunk-QUCMTKKI.js";
import "./chunk-47HCUOVE.js";
import "./chunk-LKZPAUYX.js";
import "./chunk-46ZT4DSL.js";
import "./chunk-GW7JAQTA.js";
import {
  styled_default,
  useTheme
} from "./chunk-WHEM2VI5.js";
import "./chunk-6P6YTILU.js";
import {
  require_prop_types
} from "./chunk-U3AYJTN3.js";
import "./chunk-ZD34WCX4.js";
...
function DashboardSidebarPageItem(props) {
  ...
  const pageItemContextProps = React2.useContext(DashboardSidebarPageItemContext);
  ...
  const [hoveredMiniSidebarItemId, setHoveredMiniSidebarItemId] = React2.useState(null);
  ...
  const listItem = (0, import_jsx_runtime.jsxs)(ListItem_default, {
    ...
    children: [(0, import_jsx_runtime.jsxs)(NavigationListItemButton, {
      selected,
      disabled,
      sx: {
        px: 1.4,
      ...
      children: [item.icon || isMini ? (0, import_jsx_runtime.jsxs)(Box_default, {
        sx: isMini ? {
          position: "absolute",
          left: "50%",
          top: "calc(50% - 6px)",
        ...
        children: [(0, import_jsx_runtime.jsxs)(ListItemIcon_default, {
          sx: {
            display: "flex",
            alignItems: "center",
          ...
          children: [item.icon ?? null, !item.icon && isMini ? (0, import_jsx_runtime.jsx)(Avatar_default, {
            sx: {
        ...
        }), isMini ? (0, import_jsx_runtime.jsx)(Typography_default, {
          variant: "caption",
          sx: {
            position: "absolute",
            bottom: -18,
      ...
      }) : null, !isMini ? (0, import_jsx_runtime.jsx)(ListItemText_default, {
        primary: title,
        sx: {
          ml: 1.2,
          whiteSpace: "nowrap",
      ...
      }) : null, item.action && !isMini && isSidebarFullyExpanded ? item.action : null, item.children ? (0, import_jsx_runtime.jsx)(ExpandMore_default, {
        sx: nestedNavigationCollapseSx
      }) : null]
    }), item.children && isMini ? (0, import_jsx_runtime.jsx)(Grow_default, {
      in: id === hoveredMiniSidebarItemId,
      children: (0, import_jsx_runtime.jsx)(Box_default, {
        sx: {
          position: "fixed",
          left: MINI_DRAWER_WIDTH - 2,
          pl: "6px"
        },
        children: (0, import_jsx_runtime.jsx)(Paper_default, {
          sx: {
            pt: 0.5,
            pb: 0.5,
  ...
  return (0, import_jsx_runtime.jsxs)(React2.Fragment, {
    children: [listItem, item.children && !isMini ? (0, import_jsx_runtime.jsx)(Collapse_default, {
      in: expanded,
      timeout: "auto",
      unmountOnExit: true,
      children: renderNestedNavigation(item.children)
...
function DashboardSidebarSubNavigationPageItem({
  ...
  const navigationContext = React3.useContext(NavigationContext);
  ...
  const pageItemContextProps = React3.useMemo(() => ({
    expanded: isExpanded,
    selected: isSelected,
    id,
    onClick,
    ...
    renderNestedNavigation: () => (0, import_jsx_runtime2.jsx)(DashboardSidebarSubNavigation, {
  ...
  return (0, import_jsx_runtime2.jsx)(DashboardSidebarPageItemContext.Provider, {
    value: pageItemContextProps,
    children: renderPageItem ? renderPageItem(item, {
      mini: isMini
    }) : (0, import_jsx_runtime2.jsx)(DashboardSidebarPageItem, {
      item
    })
  });
}
function DashboardSidebarSubNavigation({
  ...
  const navigationContext = React3.useContext(NavigationContext);
  const activePage = useActivePage();
  const initialExpandedItemIds = React3.useMemo(() => subNavigation.map((navigationItem, navigationItemIndex) => ({
    navigationItem,
  ...
  const [expandedItemIds, setExpandedItemIds] = React3.useState(initialExpandedItemIds);
  const handlePageItemClick = React3.useCallback((itemId, item) => {
  ...
  return (0, import_jsx_runtime2.jsx)(List_default, {
    ...
    children: subNavigation.map((navigationItem, navigationItemIndex) => {
      if (navigationItem.kind === "header") {
        return (0, import_jsx_runtime2.jsx)(ListSubheader_default, {
          sx: {
            fontSize: 12,
            fontWeight: "700",
            height: isMini ? 0 : 40,
      ...
      return (0, import_jsx_runtime2.jsx)(DashboardSidebarSubNavigationPageItem, {
        id: pageItemId,
        item: navigationItem,
...
function ThemeSwitcher() {
  ...
  return isDualTheme ? (0, import_jsx_runtime3.jsx)(Tooltip_default, {
    ...
    children: (0, import_jsx_runtime3.jsx)("div", {
      children: (0, import_jsx_runtime3.jsx)(IconButton_default, {
        ...
        children: theme.getColorSchemeSelector ? (0, import_jsx_runtime3.jsxs)(React5.Fragment, {
          children: [(0, import_jsx_runtime3.jsx)(DarkMode_default, {
            sx: {
              display: "inline",
          ...
          }), (0, import_jsx_runtime3.jsx)(LightMode_default, {
            sx: {
              display: "none",
              [theme.getColorSchemeSelector("dark")]: {
                display: "inline"
        ...
        }) : (0, import_jsx_runtime3.jsx)(React5.Fragment, {
          children: isSsr || paletteMode !== "dark" ? _DarkModeIcon || (_DarkModeIcon = (0, import_jsx_runtime3.jsx)(DarkMode_default, {})) : _LightModeIcon || (_LightModeIcon = (0, import_jsx_runtime3.jsx)(LightMode_default, {}))
        })
      })
    })
  }) : null;
...
function ToolbarActions() {
  return _Stack || (_Stack = (0, import_jsx_runtime4.jsx)(Stack_default, {
    direction: "row",
    alignItems: "center",
    children: (0, import_jsx_runtime4.jsx)(ThemeSwitcher, {})
  }));
}
  ...
  return (0, import_jsx_runtime6.jsx)(Link, {
    ...
    children: (0, import_jsx_runtime6.jsxs)(Stack_default, {
      ...
      children: [(0, import_jsx_runtime6.jsx)(LogoContainer, {
        children: ((_c = props == null ? void 0 : props.branding) == null ? void 0 : _c.logo) ?? (_ToolpadLogo || (_ToolpadLogo = (0, import_jsx_runtime6.jsx)(ToolpadLogo, {
          size: 40
        })))
...
function DashboardLayout(props) {
  ...
  const theme = useTheme();
  const brandingContext = React10.useContext(BrandingContext);
  ...
  const toggleNavigationExpanded = React10.useCallback(() => {
  ...
  const getMenuIcon = React10.useCallback((isExpanded) => {
    ...
    return (0, import_jsx_runtime7.jsx)(Tooltip_default, {
      ...
      children: (0, import_jsx_runtime7.jsx)("div", {
        children: (0, import_jsx_runtime7.jsx)(IconButton_default, {
          ...
          children: isExpanded ? _MenuOpenIcon || (_MenuOpenIcon = (0, import_jsx_runtime7.jsx)(MenuOpen_default, {})) : _MenuIcon || (_MenuIcon = (0, import_jsx_runtime7.jsx)(Menu_default, {}))
        })
      })
    });
  ...
  const getDrawerContent = React10.useCallback((isMini, viewport) => {
    var _a;
    return (0, import_jsx_runtime7.jsxs)(React10.Fragment, {
      children: [_Toolbar || (_Toolbar = (0, import_jsx_runtime7.jsx)(Toolbar_default, {})), (0, import_jsx_runtime7.jsxs)(Box_default, {
        component: "nav",
        ...
        children: [(0, import_jsx_runtime7.jsx)(DashboardSidebarSubNavigation, {
          ...
          sidebarExpandedWidth,
          renderPageItem
        }), SidebarFooterSlot ? (0, import_jsx_runtime7.jsx)(SidebarFooterSlot, {
          mini: isMini,
  ...
  return (0, import_jsx_runtime7.jsxs)(Box_default, {
    ...
    children: [(0, import_jsx_runtime7.jsx)(AppBar, {
      color: "inherit",
      position: "absolute",
      sx: {
        displayPrint: "none"
      },
      children: (0, import_jsx_runtime7.jsx)(Toolbar_default, {
        sx: {
        ...
        children: (0, import_jsx_runtime7.jsxs)(Stack_default, {
          ...
          children: [(0, import_jsx_runtime7.jsxs)(Stack_default, {
            direction: "row",
            children: [!hideNavigation ? (0, import_jsx_runtime7.jsxs)(React10.Fragment, {
              ...
              }), (0, import_jsx_runtime7.jsx)(Box_default, {
                sx: {
                  display: {
                    xs: "none",
            ...
            }) : null, (slots == null ? void 0 : slots.appTitle) ? (0, import_jsx_runtime7.jsx)(slots.appTitle, {
               ...
               */
              (0, import_jsx_runtime7.jsx)(AppTitle, {
                branding,
                ...slotProps == null ? void 0 : slotProps.appTitle
              })
            )]
            ...
            children: [(0, import_jsx_runtime7.jsx)(ToolbarActionsSlot, {
              ...slotProps == null ? void 0 : slotProps.toolbarActions
            }), (0, import_jsx_runtime7.jsx)(ToolbarAccountSlot, {
              ...slotProps == null ? void 0 : slotProps.toolbarAccount
            })]
          })]
        })
      })
    }), !hideNavigation ? (0, import_jsx_runtime7.jsxs)(React10.Fragment, {
      children: [(0, import_jsx_runtime7.jsx)(Drawer_default, {
      ...
      }), (0, import_jsx_runtime7.jsx)(Drawer_default, {
        variant: "permanent",
        sx: {
          display: {
            xs: "none",
    ...
    }) : null, (0, import_jsx_runtime7.jsxs)(Box_default, {
      sx: {
        display: "flex",
        flexDirection: "column",
        flex: 1,
...
true ? DashboardLayout.propTypes = {
   ...
   * @default false
   */
  defaultSidebarCollapsed: import_prop_types2.default.bool,
  /**
   ...
   * @default false
   */
  hideNavigation: import_prop_types2.default.bool,
  /**
   ...
   * @returns {ReactNode}
   */
  renderPageItem: import_prop_types2.default.func,
  /**
   * Width of the sidebar when expanded.
   * @default 320
   */
  sidebarExpandedWidth: import_prop_types2.default.oneOfType([import_prop_types2.default.number, import_prop_types2.default.string]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types2.default.shape({
    appTitle: import_prop_types2.default.shape({
      branding: import_prop_types2.default.shape({
        homeUrl: import_prop_types2.default.string,
        logo: import_prop_types2.default.node,
        title: import_prop_types2.default.string
    ...
    sidebarFooter: import_prop_types2.default.shape({
      mini: import_prop_types2.default.bool.isRequired
    }),
    toolbarAccount: import_prop_types2.default.shape({
      ...
      slotProps: import_prop_types2.default.shape({
        ...
        preview: import_prop_types2.default.object,
   ...
   */
  slots: import_prop_types2.default.shape({
    appTitle: import_prop_types2.default.elementType,
    sidebarFooter: import_prop_types2.default.elementType,
